...
def get_c_dataset(num_samples: int = 1000):
...
"""
        ...
        prompt += "\nMove: "
        return prompt
    game_histories: list[tuple[list[Board], list[int]]] = [generate_game_history_with_full_columns(5) for _ in range(num_samples)]
